...
let s:cterm_insertbg  = 27   " Background for insert mode and file position blocks
let s:gui_insertbg    = '#5F87FF'
let s:cterm_insertfg  = 15   " Foreground for insert mode and file position blocks
let s:gui_insertfg    = '#FFFFFF'

let s:cterm_normalbg  = 70   " Background for normal mode and file position blocks
let s:gui_normalbg    = '#87AF5F'
let s:cterm_normalfg  = 237   " Foreground for normal mode and file position blocks
let s:gui_normalfg    = '#5F5F5F'
...
let s:cterm_alert     = 198   " Modified file alert color
let s:gui_alert       = '#ff0087'
